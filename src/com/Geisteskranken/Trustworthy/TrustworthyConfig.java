...
public class TrustworthyConfig {
	...
	public static boolean readConfig() {
        ...
        InputStream input = null;
        	...
        	Trustworthy.logger.warn(Trustworthy.Name + "Disabled! Configuration error.", ex);
        	Trustworthy.plugin.disable();
        }
        try {
            input.close();
        } catch (IOException e) {
        	Trustworthy.logger.warn(Trustworthy.Name + "Disabled! Configuration error.", e);
        	Trustworthy.plugin.disable();
        }
		...
		try {
			...
			if (output != null) {
				try {
					output.close();
					Trustworthy.logger
							.info(Trustworthy.Name + "Configuration file created.");
				} catch (IOException e) {
					e.printStackTrace();
				}
			}
